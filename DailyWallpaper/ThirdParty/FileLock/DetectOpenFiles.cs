...
/*
It's ok to use any valid solution you might see easy. 
I prefer to stick with .NET Framework defaults. 3rd party app is in general my last resort
*/

// DetectOpenFiles.GetProcessesUsingFile(<file-name>)
